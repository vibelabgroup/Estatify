  ...
  return (
    <section className="py-24 bg-[#0f172a] border-y border-slate-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 text-center">
        ...
        >
          Book a quick, no-pressure discovery call. We'll show you exactly how Estatify can plug into your current setup and start converting more leads instantly.
        </motion.p>
        ...
        >
          <div className="flex flex-col items-center">
            ...
            <div className="text-sm text-slate-300 font-medium">Quick software demo</div>
          </div>
          <div className="flex flex-col items-center">
            <div className="flex items-baseline gap-1 text-5xl sm:text-6xl font-bold text-white mb-3 tracking-tight">
              100<span className="text-2xl sm:text-3xl text-blue-500 font-bold">%</span>
            </div>
            <div className="text-sm text-slate-300 font-medium">Tailored to your needs</div>
          </div>
          <div className="flex flex-col items-center">
            <div className="flex items-baseline gap-1 text-5xl sm:text-6xl font-bold text-white mb-3 tracking-tight">
              0<span className="text-2xl sm:text-3xl text-blue-500 font-bold">cost</span>
            </div>
            <div className="text-sm text-slate-300 font-medium">No commitment required</div>
          </div>
          <div className="flex flex-col items-center">
            <div className="flex items-baseline gap-1 text-5xl sm:text-6xl font-bold text-white mb-3 tracking-tight">
              1<span className="text-2xl sm:text-3xl text-blue-500 font-bold">day</span>
            </div>
            <div className="text-sm text-slate-300 font-medium">To be fully onboarded</div>
          </div>
        </motion.div>
